...
!     definitions of the phase: if relaxed=0 it introduce a field with
!     the 1/L quantization condition. If relaxed=1 it introduce a field
!     with 1/L^2 quantization
