...
//vectors parameters
#define BISSA_VECT_STRING_LENGTH 20
#define BISSA_VECT_ALIGNMENT 16
...
//constants
#define BISSA_DEFAULT_VERBOSITY_LV 1
#define BISSA_DEFAULT_USE_EO_GEOM 1
#define BISSA_DEFAULT_USE_128_BIT_PRECISION 0
#define BISSA_DEFAULT_WARN_IF_NOT_DISALLOCATED 1
#define BISSA_DEFAULT_WARN_IF_NOT_COMMUNICATED 0
#define BISSA_DEFAULT_USE_ASYNC_COMMUNICATIONS 1
#define BISSA_DEFAULT_VNODE_PARAL_DIR 0
...
#define bissa_malloc(a,b,c) (c*)internal_bissa_malloc(a,b,sizeof(c),#c,__FILE__,__LINE__)
#define bissa_free(a) internal_bissa_free((char**)&(a),__FILE__,__LINE__)
...
#define IF_VECT_NOT_INITIALIZED() if(main_arr!=((char*)&main_vect)+sizeof(bissa_vect))

//loops
#define BISSA_LOC_VOLH_LOOP(a) for(int a=0;a<loc_volh;a++)
#define BISSA_LOC_VOL_LOOP(a) for(int a=0;a<loc_vol;a++)
