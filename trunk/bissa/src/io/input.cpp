...
namespace bissa
{
  ...
  //read the bissa configuration file
  void read_bissa_config_file()
  {
    char path[1024]="bissa_config";
    ...
    else master_printf("No 'bissa_config' file present, using standard configuration\n");
