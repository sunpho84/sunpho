...
c     internal variables
      ...
      real loc_action_e,loc_action_o
     ...
     $     ,cost,pole,coef,nterm)
      ...
      do ivol=1,nvolh
         ...
         do icol=1,ncol
            loc_action_e=loc_action_e+real(chi_e(icol,ivol)
     $           *conjg(phi_e(icol,ivol)))
            loc_action_o=loc_action_o+real(chi_o(icol,ivol)
     $           *conjg(phi_o(icol,ivol)))
         enddo

         action(ivol)=action(ivol)+loc_action_e
         action(iodd)=action(iodd)+loc_action_o
