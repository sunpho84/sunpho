...
c     parameters
     ...
     $     nterm)
      ...
      do iterm=1,nterm
         call D(OE,0,v_o(1,1,iterm),chi_t_e(1,1,iterm),emu,ememu)
         call D(EO,0,v_e(1,1,iterm),chi_t_o(1,1,iterm),emu,ememu)
      enddo
         ...
         do idir=1,4
            ...
            do iterm=1,nterm
               ...
               do icol1=1,ncol
                  ...
                  c3=w3(icol1)
                  do icol2=1,ncol
                     u1(icol1,icol2)=u1(icol1,icol2)+coef(iterm)*(c1
     $                    *w2(icol2)+c3*w4(icol2))
                  enddo
               enddo
            enddo

            call rmult(ipdot(1,1,idir,ivol),r_2,u1(1,1))
