...
int main(int narg,char **arg)
{
  ...
  FILE *an_input_file=open_file("extrap_pars","r");
  ...
  for(int iens=0;iens<nens;iens++)
    {
      ...
      double FSE;
      read_formatted_from_file((char*)&(FSE),an_input_file,"%lg","FSE");
      ...
      double beee[4]={3.80,3.90,4.05,4.20};
      cout<<beee[ibeta[iens]]<<" "<<" "<<lmass[iens]<<" "<<F[iens]<<endl;
    }
